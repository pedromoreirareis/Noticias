...
public class BrasilFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Noticias>>, AdapterToViews.RecyclerViewOnClick {
    ...
    public Loader<List<Noticias>> onCreateLoader(int id, Bundle args) {
        ...
        return new LoaderTask(getContext(), Utils.preparaUrlPesquisa(page, getContext(), getString(R.string.frag_brasil)));
    }
